...
impl Subscription {
   fn summarize(&self){
        match self {
            ...
            Subscription::Basic(price, num_month) => println!("You have limited access to the site's premium features for ${price} for {num_month} months"),
...
fn main(){
    ...
    let subscription2 = Subscription::Basic(9.99, 6);
